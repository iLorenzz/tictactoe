...
public class Board{
	...
	public Symbol update(Symbol symbol, Coord coord){
		...
		if(symbol == Symbol.NONE){
			throw new IllegalArgumentException("None cannot be add to board");
		}
		
		if(matrix[coord.i()][coord.j()] != Symbol.NONE){
			throw new IllegalArgumentException("Play is not possible, position already has been played");
		}
	...
	private Symbol findSequenceInColum(int j){
